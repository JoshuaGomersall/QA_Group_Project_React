  ...
  render() {
    let MAP = {
      ...
      areas: [
        ...
        { computers: 23, seatcount: 5, name: "Floor 4 Room 6", shape: "poly", coords: [610, 130, 610, 10, 700, 10, 700, 130], preFillColor: "#", fillColor: "lightblue" },
        { computers: 3, seatcount: 1, name: "Floor 4 Room 7", shape: "poly", coords: [700, 130, 700, 10, 980, 10, 980, 130], preFillColor: "#", fillColor: "lightblue" },
      ]
    }
    return (
      <div className="App">
